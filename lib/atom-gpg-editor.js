...
atom_gpg_editor.core.observers = cljs.core.atom.call(null, cljs.core.List.EMPTY);
atom_gpg_editor.core.atom_confirm_BANG_ = function(a) {
  return atom.confirm({message:a});
};
atom_gpg_editor.core.text_editor_observer = function(a) {
  return atom_gpg_editor.core.atom_confirm_BANG_.call(null, "You opened a file!");
};
atom_gpg_editor.core.activate = function() {
  atom_gpg_editor.core.atom_confirm_BANG_.call(null, "Hello World!");
  return cljs.core.swap_BANG_.call(null, atom_gpg_editor.core.observers, cljs.core.conj, atom.workspace.observeTextEditors(atom_gpg_editor.core.text_editor_observer));
};
atom_gpg_editor.core.deactivate = function() {
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return a.dispose();
  }, cljs.core.deref.call(null, atom_gpg_editor.core.observers)));
};
