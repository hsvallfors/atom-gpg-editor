...
atom_gpg_editor.core.observers = cljs.core.atom.call(null, cljs.core.PersistentVector.EMPTY);
atom_gpg_editor.core.add_observer_BANG_ = function(a) {
  return cljs.core.swap_BANG_.call(null, atom_gpg_editor.core.observers, cljs.core.conj, a);
};
atom_gpg_editor.core.dispose_observers_BANG_ = function() {
...
atom_gpg_editor.core.will_save_buffer = function(a) {
  return atom_gpg_editor.core.atom_confirm_BANG_.call(null, cljs.core.first.call(null, clojure.string.split_lines.call(null, (new cljs.core.Keyword(null, "stdout", "stdout", -531490018)).cljs$core$IFn$_invoke$arity$1(atom_gpg_editor.child_process.spawn_BANG_.call(null, "gpg", new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["--help"], null))))));
};
atom_gpg_editor.core.created_text_editor = function(a) {
  return clojure.string.ends_with_QMARK_.call(null, a.getPath(), ".gpg") ? (atom_gpg_editor.core.atom_confirm_BANG_.call(null, "You opened a GPG file!"), atom_gpg_editor.core.add_observer_BANG_.call(null, a.getBuffer().onWillSave(atom_gpg_editor.core.will_save_buffer))) : null;
};
atom_gpg_editor.core.activate = function() {
  return atom_gpg_editor.core.add_observer_BANG_.call(null, atom.workspace.observeTextEditors(atom_gpg_editor.core.created_text_editor));
};
atom_gpg_editor.core.deactivate = function() {
  return atom_gpg_editor.core.dispose_observers_BANG_.call(null);
};
