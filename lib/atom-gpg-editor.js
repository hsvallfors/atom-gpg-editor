...
atom_gpg_editor.core._main = function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
      b.push(arguments[d]), d += 1;
    } else {
  ...
  b = 0 < b.length ? new cljs.core.IndexedSeq(b.slice(0), 0) : null;
  return atom_gpg_editor.core._main.cljs$core$IFn$_invoke$arity$variadic(b);
};
atom_gpg_editor.core._main.cljs$core$IFn$_invoke$arity$variadic = function(a) {
  return cljs.core.println.call(null, "Hello, World!");
};
atom_gpg_editor.core._main.cljs$lang$maxFixedArity = 0;
atom_gpg_editor.core._main.cljs$lang$applyTo = function(a) {
  return atom_gpg_editor.core._main.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null, a));
};
cljs.nodejs = {};
