...
var atom_gpg_editor = {child_process:{}};
atom_gpg_editor.child_process.spawnSync = cljs.nodejs.require.call(null, "child_process").spawnSync;
atom_gpg_editor.child_process.parse_process_object = function(a) {
  return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null, "stdout", "stdout", -531490018), a.stdout.toString(), new cljs.core.Keyword(null, "stderr", "stderr", -1571650309), a.stderr.toString(), new cljs.core.Keyword(null, "status", "status", -1997798413), a.status, new cljs.core.Keyword(null, "success?", "success?", -122854052), cljs.core._EQ_.call(null, a.status, 0)], null);
};
atom_gpg_editor.child_process.spawn_BANG_ = function(a, b) {
  return atom_gpg_editor.child_process.parse_process_object.call(null, atom_gpg_editor.child_process.spawnSync.call(null, a, cljs.core.clj__GT_js.call(null, b)));
};
var clojure = {string:{}};
...
atom_gpg_editor.core = {};
atom_gpg_editor.core.state = cljs.core.atom.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "created-text-editor-obs", "created-text-editor-obs", 2026031788), null, new cljs.core.Keyword(null, "will-save-buffer-obs", "will-save-buffer-obs", 18549342), null], null));
atom_gpg_editor.core.atom_confirm_BANG_ = function(a) {
  return atom.confirm(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "message", "message", -406056002), a], null)));
};
atom_gpg_editor.core.atom_error_BANG_ = function(a, b) {
  return atom.notifications.addError(a, cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "dismissable", "dismissable", 31036366), !0, new cljs.core.Keyword(null, "detail", "detail", -1545345025), b], null)));
};
atom_gpg_editor.core.encrypt_file_BANG_ = function(a) {
  return null;
};
atom_gpg_editor.core.decrypt_file_BANG_ = function(a) {
  var b = atom_gpg_editor.child_process.spawn_BANG_.call(null, "gpg", new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["--decrypt", a.getPath()], null));
  return cljs.core.truth_((new cljs.core.Keyword(null, "success?", "success?", -122854052)).cljs$core$IFn$_invoke$arity$1(b)) ? a.setText((new cljs.core.Keyword(null, "stdout", "stdout", -531490018)).cljs$core$IFn$_invoke$arity$1(b)) : atom_gpg_editor.core.atom_error_BANG_.call(null, "GPG decrypt could not be run", (new cljs.core.Keyword(null, "stderr", "stderr", -1571650309)).cljs$core$IFn$_invoke$arity$1(b));
};
atom_gpg_editor.core.created_text_editor = function(a) {
  var b = a.getPath();
  return cljs.core.truth_(b) && clojure.string.ends_with_QMARK_.call(null, b, ".gpg") ? (cljs.core.swap_BANG_.call(null, atom_gpg_editor.core.state, cljs.core.assoc, new cljs.core.Keyword(null, "will-save-buffer-obs", "will-save-buffer-obs", 18549342), a.getBuffer().onWillSave(function(b, d) {
    return function() {
      return atom_gpg_editor.core.decrypt_file_BANG_.call(null, a);
    };
  }(b, b))), atom_gpg_editor.core.decrypt_file_BANG_.call(null, a)) : null;
};
atom_gpg_editor.core.activate = function() {
  return cljs.core.swap_BANG_.call(null, atom_gpg_editor.core.state, cljs.core.assoc, new cljs.core.Keyword(null, "created-text-editor-obs", "created-text-editor-obs", 2026031788), atom.workspace.observeTextEditors(atom_gpg_editor.core.created_text_editor));
};
atom_gpg_editor.core.deactivate = function() {
  (new cljs.core.Keyword(null, "created-text-editor-obs", "created-text-editor-obs", 2026031788)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, atom_gpg_editor.core.state)).dispose();
  return (new cljs.core.Keyword(null, "will-save-buffer-obs", "will-save-buffer-obs", 18549342)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, atom_gpg_editor.core.state)).dispose();
};
module.exports = cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "activate", "activate", 441219614), atom_gpg_editor.core.activate, new cljs.core.Keyword(null, "deactivate", "deactivate", -1313810707), atom_gpg_editor.core.deactivate, new cljs.core.Keyword(null, "serialize", "serialize", -69216574), cljs.core.constantly.call(null, null)], null));
