...
atom_gpg_editor.core.created_text_editor = function(a) {
  atom_gpg_editor.core.atom_confirm_BANG_.call(null, "You opened a file!");
  return atom_gpg_editor.core.add_observer_BANG_.call(null, a.getBuffer().onWillSave(atom_gpg_editor.core.will_save_buffer));
};
